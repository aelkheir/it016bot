...
from flaskr.bot.user.handlers.stage_three import list_lab_files, list_tutorial_files, send_all_course_refferences, send_all_lecture_files, send_assignment, send_course_exam, send_course_refference, send_file
from flaskr.bot.user.handlers.stage_two import  list_course_assignments, list_course_exams, list_course_labs, list_course_tutorials, list_lecture_files, list_course_refferences
